...
program.command('dev')
  .description('run dev server within @vswift/designer (For package maintainers only)')
  .action(async () => {
...
program.command('build')
  .description('build for package of @vswift/cli, @vswift/utils or @vswift/designer (For package maintainers only)')
